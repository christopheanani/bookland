...
<section class="orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Id utilisateur : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         <p> Commande sur : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> Moyen de paiement : <span><?php echo $fetch_orders['method']; ?></span> </p>
