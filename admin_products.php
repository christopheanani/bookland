...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" name="price" class="box" placeholder="entrer le prix du produit" required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_products.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">mèttre à jour</a>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_name" value="<?php echo $fetch_update['name']; ?>" class="box" required placeholder="entrer le nom du produit">
      <input type="number" name="update_price" value="<?php echo $fetch_update['price']; ?>" min="0" class="box" required placeholder="entrer le prix du produit">
      <input type="file" class="box" name="update_image" accept="image/jpg, image/jpeg, image/png">
      <input type="submit" value="mettre à jour" name="update_product" class="btn">
      <input type="reset" value="quitter" id="close-update" class="option-btn">
   </form>
   <?php
         }
      }
