...
if (isset($_POST['add_to_cart'])) {
   ...
   if (mysqli_num_rows($check_cart_numbers) > 0) {
      ...
      $message[] = 'Produit(s) ajouté(s) aux panier!';
   }
}
...
<body>
   ...
   <section class="home">
      <div class="content">
         <p>Choisissez votre livre!</p>
         <h3>Trouver un livre pour tous les âges</h3>
         <p>Des livres qui comptent vraiment.</p>
   ...
   <section class="products">
      ...
      <h1 class="title">Nouveaux livres</h1>
