...
<section class="shopping-cart">
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'désactiver'; ?>" onclick="return confirm('tout supprimer du panier ?');">supprimer tout</a>
   </div>
   ...
   <div class="cart-total">
      ...
      <div class="flex">
         ...
         <a href="checkout.php" class="btn <?php echo ($grand_total > 1)?'':'désactiver'; ?>">Procéder au paiement</a>
      </div>
   </div>
